...
import br.com.alura.literalura.literalura.model.*;
...
public class Principal {
    ...
    private DadosLivro obterDadosApi() {
        ...
        var json = consumoApi.obterDadosApi(ENDERECO + nomeLivro.replace(" ", "+"));
    ...
    private void listarTop5LivrosBaixados() {
        List<Livro>top5LivrosBaixados=livroRepository.findTop5ByOrderByDownloadsDesc();
        top5LivrosBaixados.forEach(l->
                System.out.println("Livro: "+l.getTitulo()+", Downloads: "+l.getDownloads()));
    }
